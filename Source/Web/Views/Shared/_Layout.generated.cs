...
WriteAttribute("href", Tuple.Create(" href=\"", 2475), Tuple.Create("\"", 2509)
            
            #line 55 "..\..\Views\Shared\_Layout.cshtml"
, Tuple.Create(Tuple.Create("", 2482), Tuple.Create<System.Object, System.Int32>(Url.Action("Index", "All")
...
WriteAttribute("href", Tuple.Create(" href=\"", 2560), Tuple.Create("\"", 2595)
            
            #line 56 "..\..\Views\Shared\_Layout.cshtml"
, Tuple.Create(Tuple.Create("", 2567), Tuple.Create<System.Object, System.Int32>(Url.Action("PDF", "Export")
...
WriteAttribute("class", Tuple.Create(" class=\"", 3992), Tuple.Create("\"", 4059)
, Tuple.Create(Tuple.Create("", 4000), Tuple.Create("modal", 4000), true)
, Tuple.Create(Tuple.Create(" ", 4005), Tuple.Create("fade", 4006), true)
, Tuple.Create(Tuple.Create(" ", 4010), Tuple.Create("hidden-print", 4011), true)
            
            #line 83 "..\..\Views\Shared\_Layout.cshtml"
, Tuple.Create(Tuple.Create(" ", 4023), Tuple.Create<System.Object, System.Int32>(this.TempData.GetMessagePriority()
