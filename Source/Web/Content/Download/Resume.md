...
### HIW Developers & Services (http://developers.healthindicators.gov)
Exposes data from the HIW. Custom CodeGenerator templates were used to generate the service methods and documentation. The system includes a real-time URL builder/service tester and API key registration/verification. **Tech. Used:** C#, MS SQL, HTML5, CSS3, Bootstrap, JS, Knockout, UI/UX
...
### Platform Liberty
The goal of this project is to provide an inexpensive, easy-to-use web application for liberty candidates. This platform will be available to any candidate who is on the side of liberty - regardless of party their party affiliation. 10+ instances. **Tech. Used:** Rails, My SQL, HTML5, CSS3, Bootstrap, JS, Knockout, UI/UX

### Carson for Congress (http://jeffreycarson.platformliberty.org)
Built atop Platform Liberty and customized to fit the needs of Jeffrey Carson's 2014 Congressional campaign. **Tech. Used:** Rails, My SQL, HTML5, CSS3, Bootstrap, JS, Knockout, UI/UX

### AeroBazaar (http://aerobazaar.com)
A robust aircraft listing engine allows potential aircraft buyers to easily find what they're looking for. Sellers can manage their inventory and add detailed information for each of their aircraft. **Tech. Used:** PHP, My SQL, HTML5, CSS3, Bootstrap, JS, Knockout, UI/UX
...
## Technology
- .NET, C#, ASP.NET MVC, ASP.NET WebForms, Ruby on Rails, PHP, Java,
...
## Work History
###i360: 9/2015 - Present; Arlington, Virginia
**Solutions Developer**
...
- Develop and publicly release custom code-generation tool, CodeGenerator (TheCodeGenerator.com (http://thecodegenerator.com)), which provides a huge boost to team productivity as well as code stability and versatility.
